...
let init_email_deck () : deck = [
  ...
  create_card "Bourse étudiante" "Bourse acceptée, recevez 150k" (GainMoney 150);
  create_card "Frais CVEC" "Vous devez payer la CVEC qui s'élève à 50 k" (LoseMoney (-50));
